...
python train.py --env MontezumaRevenge-v0 --config '{"gamma": 0.99, "lambda": 0.95, "clip_param": 0.2, "kl_coeff": 1.0, "num_sgd_iter": 20, "sgd_stepsize": 1e-4, "sgd_batchsize": 32768, "horizon": 5000, "devices": ["/gpu:0", "/gpu:1", "/gpu:2", "/gpu:3"], "tf_session_args": {"device_count": {"GPU": 4}, "log_device_placement": false, "allow_soft_placement": true}, "timesteps_per_batch": 200000, "num_workers": 64, "write_logs": false}' --alg PPO --upload-dir s3://bucketname/
